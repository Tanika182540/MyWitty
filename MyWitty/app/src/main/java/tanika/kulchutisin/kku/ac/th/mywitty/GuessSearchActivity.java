...
public class GuessSearchActivity extends AppCompatActivity {
    ...
    private void setAdapter(final String searchedString) {
        databaseReference.child("station").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Intent intent = new Intent(GuessSearchActivity.this,popUp.class);
                intent.putExtra("tel",tel);

                searchAdapter = new SearchAdapter(GuessSearchActivity.this, codeList,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(GuessSearchActivity.this, Main2Activity.class);
                String email = "";
                String name = "";
